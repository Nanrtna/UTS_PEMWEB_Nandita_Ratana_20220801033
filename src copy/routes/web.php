...
Route::group(['prefix' => 'admin', 'as' => 'admin.', 'namespace' => 'Admin', 'middleware' => ['auth']], function () {
    ...
    // supir bus
    Route::delete('supir buss/destroy', 'supir busController@massDestroy')->name('supir buss.massDestroy');
    Route::post('supir buss/media', 'supir busController@storeMedia')->name('supir buss.storeMedia');
    Route::post('supir buss/ckmedia', 'supir busController@storeCKEditorImages')->name('supir buss.storeCKEditorImages');
    Route::resource('supir buss', 'supir busController');
